...
let person1 =new Person("Shariq","Zakir",24,"pakistan","karachi")
let person2 =new Person("Khrram","Shehzad",22,"pakistan","islamabad")
...
let Teacher = new teacher("Shariq ","male",20000)
console.log(teacher)
